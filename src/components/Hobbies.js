...
export default function Experience() {
  return (
    <div
      id="hobbies"
      className="flex flex-col justify-start items-center h-screen bg-gray-800 p-24"
    >
      <div className="flex flex-row justify-center items-center">
        <div className="h-4 w-4 bg-white mr-2"></div>
        <h1 className="text-white uppercase text-3xl font-bold">Hobbies</h1>
      </div>
      <ul className="list-disc flex flex-col items-start justify-center self-center my-auto p-8 text-white text-xl">
        <li>
